    ...
    if (selected.brandName.length > 0) {
      ...
      const message = encodeURIComponent(
        `Thanks for reaching Us! 
          \n Trip Type : ${TripType}  ,
        \n PickUp Address : ${AirportPickUp}  , 
          \n Dropping Address : ${AirportDropUp},
        \n Booked Vehicle Name: ${selected.brandName},
        \n Date of Booking : ${AirportDate} , 
        \n Time to Pickup : ${AirportTime},
            \n Booked Vehicle Name: ${selected.brandName},
    ...
    <>
      <m.div className="vehicleList_container">
        ...
        <div className="actions">
          <div className="previous" onClick={() => handleAirportlNext()}>
...
export default AirportVehicleList;
