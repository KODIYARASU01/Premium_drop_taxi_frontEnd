  ...
  let handleRoundNext = () => {
    if (selected.brandName.length > 0) {
      ...
      const message = encodeURIComponent(
        ...
        \n PickUp Address : ${RoundPickUp}  , 
        \n Dropping Address : ${RoundDropUp},
        \n FromDate of Booking : ${fromDate} , 
         \n ToDate of Trip End : ${toDate} , 
         \n Booked Vehicle Name: ${selected.brandName},
        \n Time to Pickup : ${RoundTime},
            \n Booked Vehicle Name: ${selected.brandName},
    ...
    <>
      <m.div className="vehicleList_container">
        ...
        <div className="actions">
          <div className="previous" onClick={() => handleRoundNext()}>
...
export default RoundVehicleList;
