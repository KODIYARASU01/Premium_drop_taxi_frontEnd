...
import handleClick from "../WatsupMessage";
let vehicle_list = [
  {
    id: 1,
    brandName: "Dzire",
...
const VehicleList = ({
  ...
  function handleFilter(name) {
    ...
    let price = filtered.map(
      (item) => (
        setCharges(parseInt(item.per_km) * parseInt(distance)),
