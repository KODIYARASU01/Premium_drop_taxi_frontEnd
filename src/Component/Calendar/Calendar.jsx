              ...
              ({ date, currentMonth, today }, index) => (
                <div key={index}>
                  <p
                    ...
                    id="date"
                    onClick={() => {
                      // setDate(date.toString().slice(0, 17));
                      let currentDate=date.$d;

                      setDate(currentDate.toString().slice(0, 16));
                      // setFromDate(date.toString().slice(0, 17));
                      // setToDate(date.toString().slice(0, 17));
                      // setLocalDate(date.toString().slice(0, 17));
                      // setAirportDate(date.toString().slice(0, 17));
